                ...
                <?php if ($query) {
                    foreach ($rows as $row) { ?>
                        ...
                        <tr>
                            ...
                            <td><?= $row['LocalName'] ?></td>
                            <?php
                            $checklocal = "SELECT COUNT(*) FROM reason WHERE code = :code";
                            try {
                            ...
                            if ($checkRows > 0) {
                                try {
                                    $sqlUPDATE = "UPDATE reason SET LocalName = :LocalName WHERE code = :code";
                                ...
                                try {
                                    $sqlINSERT = "INSERT INTO reason (code, LocalName) VALUES (:code, :LocalName)";
